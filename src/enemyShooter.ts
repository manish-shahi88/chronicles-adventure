...
// import enemyShooter from "/enemyShooter.png";
...
//         Stones.push(new Stone({ x: this.position.x, y: this.position.y }, { velocityX: -10, velocityY: 0 }, 100, 100))
//         // this.frame++;
//         // if (this.frame > 10) {
//         //     this.frame = 0;
//         // }
...
export default class EnemyShooter {
    ...
    constructor({ x, y }: EnemyParams) {
        ...
        this.throwInterval = 100; // Adjust this value to control the frequency of throwing stones
        this.throwTimer = 0;
    }
