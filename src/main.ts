...
function init() {
    ...
    genericObjects = [
        ...
        new GenericObject({ x: 300, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 2, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 3, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 5, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 7, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 9, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 10, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 12, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 13, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 14, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 15, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 16, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 17, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 18, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 19, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 20, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 21, y: canvas.height, image: treeImg }),
        new GenericObject({ x: 300 + treeSpace * 22, y: canvas.height, image: treeImg }),
